...
export default async function PaymentSuccessPage({
  ...
  if (!oid || !isSafeOid(oid)) {
    return <ErrorCard title="Bağlantı geçersiz" desc="Sipariş numarası eksik veya geçersiz." />
  }
  ...
  if (error || !data) {
    return <ErrorCard title="Rezervasyon bulunamadı" desc="Kayıt yüklenemedi. Lütfen destek ile iletişime geçin." />
  }
