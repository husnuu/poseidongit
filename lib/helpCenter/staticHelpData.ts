...
export const STATIC_HELP_CATEGORIES: StaticHelpCategory[] = [
  ...
  },
  {
    ...
    isFeatured: true,
    articles: [
      { slug: 'tur-fiyatina-neler-dahil', title: "Tur fiyatına neler dahil?", answer: "Dahil olanlar tur tipine göre değişir; genellik liste yüzme molaları, rehberlik/kaptanlık ve güvenlik ekipmanları gibi çekirdek kalemleri kapsar. Menü, içecek veya özel alan (ör. üst sınıf oturum) gibi kalemler pakete göre eklenir veya ayrı satılır; net liste ilgili çeşme tekne turu sayfasında bulunur. Ödeme yapmadan önce “dahil olanlar” bölümünü okumanız sürprizi önler. Poseidon şeffaf paketleme ile güven verir." },
      { slug: 'cocuk-indirimi-var-mi-yas-siniri-nedir', title: "Çocuk indirimi var mı? Yaş sınırı nedir?", answer: "Yaş bazlı fiyatlandırma ve indirimler tur sayfasındaki bilet sınıfları ve yaş aralıklarına göre otomatik hesaplanır; çocuk için indirim varsa seçim ekranında net görünür. Yaş sınırı veya ücretsiz bebek politikası tur bazında farklılık gösterebilir—rezervasyon sırasında doğum tarihi veya yaş grubunu doğru seçmek önemlidir. Çeşme tekne turu aileler için popülerdir; yanlış yaş grubu seçimi girişte düzeltme gerektirebilir. Şüphede sayfadaki açıklamayı okuyun veya yazın." },
      { slug: 'bebekler-icin-fiyat-var-mi', title: "Bebekler için fiyat var mı?", answer: "Bebek ücreti ve kontenjana dahil olup olmadığı seçilen turun yaş kurallarına bağlıdır; rezervasyon formunda bebek sayısı genellikle ayrı girilir ve varsa ücret satırı görünür. Güvenlik ve can yeleği kullanımı bebeklerde kritiktir; kısıt varsa tur metninde belirtilir. Çeşme tekne turu için erken rezervasyon, bebekli ailelerde yan yana oturum taleplerini kolaylaştırır. Politika net değilse iletişime tek satır yazmanız yeterli." },
  ...
  },
  {
    ...
    articles: [
      ...
      { slug: 'hamileler-katilabilir-mi', title: "Hamileler katılabilir mi?", answer: "Hamilelikte her vücut farklı hisseder; tekne hafif hareket edebilir, güneş de yorabilir. Mutlaka doktorunuza danışın; size uygunsa gelin, rahatsızlık hissederseniz gölgeli tarafa geçin. Bize hamile olduğunuzu önceden yazarsanız oturacağınız yeri daha konforlu ayarlamaya çalışırız." },
