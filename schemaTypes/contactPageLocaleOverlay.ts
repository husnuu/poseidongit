  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'mapDirections', title: 'Harita: yol tarifi', type: 'string' }),
        defineField({ name: 'mapWhatsapp', title: 'Harita: WhatsApp paylaş', type: 'string' }),
        defineField({ name: 'mapActionsAria', title: 'Harita butonları aria-label', type: 'string' }),
